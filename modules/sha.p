  ...
  (let ((h1 h2 h3 h4 h5 h6 h7 h8) (list H1 H2 H3 H4 H5 H6 H7 H8)
    ...
    (dotimes (i 64)
      (<- T1 (int32 (+ h8 (sig1 h5) (Ch h5 h6 h7) ([] K i) ([] W i)))
          ...
          h8 h7 h7 h6 h6 h5 h5 (int32 (+ h4 T1))
          h4 h3 h3 h2 h2 h1 h1 (int32 (+ T1 T2))))
    (map int32 (list (+ H1 h1)
                     (+ H2 h2)
                     (+ H3 h3)
                     (+ H4 h4)
                     (+ H5 h5)
...
(function sha256.sum (msg)
  ...
  (let ((H1 H2 H3 H4 H5 H6 H7 H8)
    ...
    (dotimes (i 8)
      (let (x ([] (list H1 H2 H3 H4 H5 H6 H7 H8) i))
...
(function! main (args)
  (assert (= (hex (sha256.sum ""))
             "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"))
  (assert (= (hex (sha256.sum "d3"))
             "f451a61749c611ba0fa0e16c61831db44f38c611dff25879cf271a24c81a88b6"))
  (assert (= (hex (sha256.sum "11af"))
             "5e768653556b74ba4e447d51f3f234eb70006a75a9faf8b0e487603f31ad4cf8"))
  (assert (= (hex (sha256.sum ""))
