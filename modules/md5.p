...
(function! main (args)
  ...
  (assert (= (hex (md5.sum "a"))
             "0cc175b9c0f1b6a831c399e269772661"))
  (assert (= (hex (md5.sum "abc"))
             "900150983cd24fb0d6963f7d28e17f72"))
  (assert (= (hex (md5.sum "message digest"))
             "f96b697d7cb7938d525a2f31aaf161d0"))
  (assert (= (hex (md5.sum "abcdefghijklmnopqrstuvwxyz"))
             "c3fcd3d76192e4007dfb496cca67e13b"))
  (assert (= (hex (md5.sum "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"))
             "d174ab98d277d9f5a5611c2c9f419d9f"))
  (assert (= (hex (md5.sum "12345678901234567890123456789012345678901234567890123456789012345678901234567890"))
