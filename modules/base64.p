...
(function base64.decode-byte (b :opt accept-padding?)
  (if (<= 0x41 b 0x5a) (- b 0x41)
      ...
      (raise ArgumentError "illegal base64")))
...
(function! main (args)
  ...
  (assert (= (base64.encode "A") "QQ=="))
  (assert (= (base64.encode "AB") "QUI="))
  (assert (= (base64.encode "ABC") "QUJD"))
  (assert (= (base64.encode "ABCD") "QUJDRA=="))
  (assert (= (base64.encode "ABCDE") "QUJDREU="))
  (assert (= (base64.encode "ABCDEF") "QUJDREVG"))
  (assert (= (base64.encode "ABCDEFG") "QUJDREVGRw=="))
  (assert (= (base64.encode "abc123!?$*&()'-=@~") "YWJjMTIzIT8kKiYoKSctPUB+"))
  (assert (= (base64.url-safe-encode "abc123!?$*&()'-=@~") "YWJjMTIzIT8kKiYoKSctPUB-"))
  (assert (= (base64.decode (base64.encode "")) ""))
  (assert (= (base64.decode (base64.encode "A")) "A"))
  (assert (= (base64.decode (base64.encode "AB")) "AB"))
  (assert (= (base64.decode (base64.encode "ABC")) "ABC"))
  (assert (= (base64.decode (base64.encode "ABCD")) "ABCD"))
  (assert (= (base64.decode (base64.encode "ABCDE")) "ABCDE"))
  (assert (= (base64.decode (base64.encode "ABCDEF")) "ABCDEF"))
  (assert (= (base64.decode (base64.encode "ABCDEFG")) "ABCDEFG"))
  (assert (= (base64.decode (base64.encode "abc123!?$*&()'-=@~")) "abc123!?$*&()'-=@~"))
  (assert (= (base64.decode (base64.url-safe-encode "abc123!?$*&()'-=@~")) "abc123!?$*&()'-=@~")))
