...
コンスとはParenのオブジェクトへのポインタを二つ持ったオブジェクトである。
二つのポインタが指す領域のうち、
片方をcar、もう一方をcdrと呼ぶ。
...
ここで、コンスの厳密な定義を与える。
1. コンスはParenのオブジェクトへの二つのポインタcar、cdrをもつ
2. carは任意のParenのオブジェクトを指せる
